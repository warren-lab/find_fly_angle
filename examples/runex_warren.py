...
image_dir = '/home/flyranch/image_data/20240415/fly1m/20240415120905'
...
angle_list = []
eval_list = []
for file_number, file_name in enumerate(image_files[100:200]):
    ...
    print(f"FLIPPED: {angle_data['flipped']}")
    
    # eval = input("Frame Correct?:")
...
print(f"Orientation Accuracy: {eval_list.count('y')/len(eval_list)}")
